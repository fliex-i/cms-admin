...
module.exports = app => {
  ...
  router.get(
    '/admin/sys/config/:name',
    app.middleware.sys.authAdminToken(),
    controller.sys.config.info
  );
  router.post(
    '/admin/sys/config/:name/update',
    app.middleware.sys.authAdminToken(),
    controller.sys.config.edit
  );
  router.get(
    /^\/pages\/(.*)$/,
    app.middleware.sys.authAdminToken(),
    controller.sys.index.getJson
  );
  router.get(
    '/admin/site.json',
    app.middleware.sys.authAdminToken(),
    controller.sys.index.site
  );
  router.get(
    '/admin/sys/server/getMiddleware',
    app.middleware.sys.authAdminToken(),
    controller.sys.server.getMiddleware
  );
  router.get(
    '/admin/sys/server/getController',
    app.middleware.sys.authAdminToken(),
    controller.sys.server.getController
  );
  router.get(
    '/admin/sys/server/getAction',
    app.middleware.sys.authAdminToken(),
    controller.sys.server.getAction
  );
  router.get(
    '/admin/sys/server/restart',
    app.middleware.sys.authAdminToken(),
